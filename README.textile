...
note: if no name parameter is provided the first ten foods is returned.

## Create a thing with properties
HTTP POST to /foods.json
...
HTTP POST to /foods/{food_id}/properties.json
Example json to post:
{ “properties” : 
[
	{“name” : “color”, “value” : “green”}
...
HTTP GET to /foods/{food_id}.json
